 ...
 */
package team18.com.plunder.utils.barcode;
...
import team18.com.plunder.utils.camera.CameraSource;
import team18.com.plunder.utils.camera.CameraSourcePreview;
import team18.com.plunder.utils.barcode.*;
...
public final class BarcodeCaptureActivity extends AppCompatActivity
    ...
    public void onCreate(Bundle icicle) {
        ...
        Button manualInput = (Button) findViewById(R.id.manual_input_button);
    ...
    private void createCameraSource(boolean autoFocus, boolean useFlash) {
        ...
        if (!barcodeDetector.isOperational()) {
            ...
            if (hasLowStorage) {
                Toast.makeText(this, "Low Storage Error",
